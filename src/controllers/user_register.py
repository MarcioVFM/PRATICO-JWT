...
class UserRegister:
    ...
    def __registry_new_user(self, username: str, password: str) -> None:
        self.__user_repository.registry_user(username, password)

    def __format_response(self, username: str) -> dict:
        return{
            'message': f'The new user {username} as been created'
        }